        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary" href="{{ route('knowledge.showkm') }}">View details &raquo;</a>
                </div>                
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary" href="{{ route('linkmod.showlinkmod') }}">View details &raquo;</a>
                </div>
            </div>
        </div>
    </div>
