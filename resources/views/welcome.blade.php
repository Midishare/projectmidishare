...
@section('content')
                ...
                <div class="">
                    <div class="card mb-3 border border-0">
                        <div class="bg-midi rounded text-white">
                            ...
                            <img class="card-img-top image1 object-fit-cover" src="{{ asset('icon/header-image.jpg') }}"
                                alt="Card image cap">
                        </div>
                        <div class="card-body ">
                            <div class="d-flex flex-column flex-md-row justify-content-between">
                                <div class="p-2">
                                    <p>Knowledge Management mempunyai tujuan untuk menyimpan dan menyebarkan pengetahuan
                                        pembelajaran yang ada di Alfamidi. Kami juga menyimpan informasi-informasi mengenai
                                        berbagai acara. Yuk kepoin Knowledge Management!</p>
                                    <p>Kami memiliki:</p>
                    ...
                    <div class="container-program">
                        ...
                        <div class="stats-container-program">
                            <div class="stat-card-program">
                                ...
                                <div class="stat-description-program">Kumpulan Rekaman Webinar Alfamidi yang informatif dan
                                    relevan dengan kebutuhan sekarang</div>
                            </div>
                            <div class="stat-card-program">
                                <div class="stat-number-program">Training</div>
                                <div class="stat-description-program">Kumpulan rekaman dan informasi mengenai Training
                                    Kompetensi di Alfamidi</div>
                            </div>
                            <div class="stat-card-program">
                                <div class="stat-number-program">COP</div>
                                <div class="stat-description-program">Kumpulan infomasi mengenai community of practice di
                                    Alfamidi</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            <div class="d-flex flex-column flex-md-row justify-content-between bg-midi rounded text-white">
                                <div class="p-3">
                                    ...
                                    <img class="card-img-top image1 object-fit-fill " src="{{ asset('icon/gmbr3.png') }}"
                                        alt="Card image cap">
                                </div>
                                <div class="p-3 margin-materi">
                                    <ol type="1">
                                        <li>Dapatkan Informasi terkini mengenai Webinar, Artikel dan Podcast Alfamidi</li>
                                        <li>Dapatkan materi pembelajaran dari repositori, training, courses, dan masih
                                            banyak lagi!</li>
                                        <li>Dapatkan informasi terkini mengenai kegiatan-kegiatan Community of Interest dan
    ...
    <script>
        ...
        document.getElementById('contactForm').addEventListener('submit', function(e) {
            ...
            const subject = 'Pendaftaran Anggota Midishare';
            const body = `Halo! Saya ingin mendaftar menjadi anggota Midishare:\n\n` +
                `Nama: ${fullname}\n` +
                `NIK: ${nik}\n` +
                `Lokasi: ${lokasi}\n` +
                `Branch: ${branch}\n` +
            ...
            const mailtoLink =
                `mailto:webinar.alfamidi@mu.co.id?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
