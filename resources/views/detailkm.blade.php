...
<div class="center-content" style="margin-top: 3rem;">
    <div class="content-wrapper">  
        <div>
            <a href="/repositorykm" class="btn" style="margin-top: 5rem; margin-right:31rem;">
                <i class="bi bi-arrow-left"></i> Kembali
            </a> 
        </div>     
        @if($repositorykm)
            <div class="content">
                <h2 style="margin-top: 2rem;">{{ $repositorykm->judul }}</h2>
                <h2 style="margin-top: 2rem;">{{ $repositorykm->dokumenfile }}</h2>
