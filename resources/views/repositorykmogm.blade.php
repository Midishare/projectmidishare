    ...
    <div class="container" style="margin-top: 2rem;">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img class="card-img-top" src="{{ asset('storage/gambar/' . $repo->gambarrepoogm) }}" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title text-dark">
                            <a href="{{ asset('storage/dokumen/' . $repo->dokumenfilerepoogm) }}" target="_blank">{{ $repo->judulrepoogm }}</a>
                        </h5>
                    </div>
                </div>
            </div>
