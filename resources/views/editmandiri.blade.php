            ...
            <div class="col-md-8 col-sm-12 bg-white p-4">
                ...
                <form method="post" action="{{ route('belajarmandiri.editmandiri_process') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$belajarmandiri->judul}}" name="judul" placeholder="Judul Berita">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="published_at" name="published_at" value="{{ $belajarmandiri->published_at->format('Y-m-d') }}">
                    </div>
                    <div class="form-group">
