...
<section class="gradient-bg py-5">
    ...
    <h4>Repository Knowledge People Development Manager</h4>
    </div>
</section>
...
<section style="margin-top: 0.25rem;"> <!-- Mengurangi margin-top -->
    <div class="container">
        <div class="row align-items-center justify-content-end"> <!-- Menggunakan justify-content-end untuk memulai item dari kanan -->
            ...
            <div class="col-auto">
                <form action="{{ route('video.showvideomod') }}" method="GET" class="flex-grow-4">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            ...
                            @if(!empty($video_id))
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">{{ $video->judulvidmod }}</h6>
                            @else
