...
@section('content')
    ...
    <section>
        <div class="container text-center p-5 mt-5">
            <h2>Belajar mandiri dan obat-obatan</h2>
            @if ($errors->any())
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
                <div class="col">
                    <div class="card h-100 p-3">
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            <a class="btn btn-secondary" href="{{ route('belajarmandiri.show_by_adminmandirishow') }}">View
                                details &raquo;</a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100 p-3">
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            <a class="btn btn-secondary" href="{{ route('admin.bukupintarwh.index') }}">View details
                                &raquo;</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card h-100 p-3">
                        <img class="bd-placeholder-img rounded-circle mx-auto" width="200" height="150"
                            src="{{ asset('icon/ms10.png') }}" alt="Ware House">
                        <div class="card-body">
                            <h4 class="card-title text-center">Standarisasi obat-obatan</h4>
                        </div>
                        <div class="card-footer d-flex justify-content-center">
                            <a class="btn btn-secondary" href="{{ route('healthcare') }}">View details &raquo;</a>
                        </div>
                    </div>
                </div>
            </div>
