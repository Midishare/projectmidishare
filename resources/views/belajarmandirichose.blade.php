                ...
                <div class="col">
                    <div class="card h-100 p-3">
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            <a class="btn btn-secondary" href="{{ route('belajarmandiri.show_by_adminmandirishow') }}">View details &raquo;</a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100 p-3">
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            <a class="btn btn-secondary" href="{{ route('admin.bukupintarwh.index') }}">View details &raquo;</a>
                        </div>
                    </div>
                </div>
                <div class="col">
