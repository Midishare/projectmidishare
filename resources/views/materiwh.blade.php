...
{{-- <div class="container-fluid p-3 bg-white text-white text-center mt-4">
</div>
        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary"  href="repositorylinkwh">View details &raquo;</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary" href="{{ route('videowh.showvideomodwh') }}">View details &raquo;</a>
                </div>
            </div>
        </div>
    </div>
