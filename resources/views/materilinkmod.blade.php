        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary" href="{{ route('knowledge.show_by_adminkmshow') }}">View details &raquo;</a>
                </div>                
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary" href="{{ route('linkmod.show_by_adminlinkshow') }}">View details &raquo;</a>
                </div>
            </div>
        </div>
    </div>
