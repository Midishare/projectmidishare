...
<div style="margin-top: 7rem;" class="animated fadeIn">
    ...
    <div class="col-md-12 bg-white p-4">
        <div class="row">
            ...
            <div class="col-md-2 text-right">
                ...
                {{-- <div class="row g-2 align-items-center justify-content-end">
                    <div class="col-auto">
                        <input type="text" id="searchEventInput" class="form-control" aria-describedby="searchHelpInline" placeholder="Search...">
                    </div>
                    <div class="col-auto">
        ...
        <form id="bulkDeleteFormEvent" method="POST" action="{{ route('events.bulk_delete') }}">
            @csrf
            @method('DELETE')
            <button type="button" class="btn btn-danger mt-4" onclick="confirmBulkDeleteEvent()">Hapus yang dipilih</button>
            ...
            <table class="table table-responsive table-bordered table-hover table-striped" style="margin-top: 1rem;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ asset('storage/event_images/' . $event->image) }}" alt="Gambar Event" style="max-width: 100px;"></td>
                        <td>
                            <a href="{{ route('events.edit', $event->id) }}" class="btn btn-warning">
                                <i class="bi bi-pencil-square" style="color: azure"></i>
                            </a>
                            <a href="javascript:void(0);" onclick="confirmDeleteEvent({{ $event->id }})" class="btn btn-danger" style="color: azure">
...
<script>
    function searchEvent() {
        ...
        // Redirect to the events page with the search query
    ...
    // Confirm Bulk Delete for Events
    ...
    // Confirm Single Delete for Event
