        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary" href="{{ route('knowledgewh.show_by_adminkmwhshow') }}">View details &raquo;</a>
                </div>                
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary" href="{{ route('linkwh.show_by_adminlinkwhshow') }}">View details &raquo;</a>
                </div>
            </div>
        </div>
    </div>
