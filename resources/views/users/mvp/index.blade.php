        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary" href="{{ route('mvp.materi') }}" class="btn btn-primary btn-lg">Views Details</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-secondary" href="{{ route('mvp.video') }}">Views details &raquo;</a>
                </div>
            </div>
        </div>
    </div>
