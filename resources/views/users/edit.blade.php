        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select id="class" class="form-control @error('class') is-invalid @enderror" name="class" required>
                    ...
                    <option value="MOD" {{ old('class', $user->class) == 'MOD' ? 'selected' : '' }}>MOD</option>
                    <option value="SME" {{ old('class', $user->class) == 'SME' ? 'selected' : '' }}>SME</option>
                    <option value="FL" {{ old('class', $user->class) == 'FL' ? 'selected' : '' }}>Financial Literasi</option>
