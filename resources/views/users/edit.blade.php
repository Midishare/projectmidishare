            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" name="lokasi" id="lokasi"
                        ...
                        value="{{ old('lokasi', $user->lokasi) }}" required>
                    @error('lokasi')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select id="role" class="form-control @error('role') is-invalid @enderror" name="role" required>
                        <option value="user"
                            {{ old('role', $user->getRoleNames()->first()) == 'user' ? 'selected' : '' }}>User</option>
                        <option value="auditor"
                            {{ old('role', $user->getRoleNames()->first()) == 'auditor' ? 'selected' : '' }}>Auditor
                        </option>
