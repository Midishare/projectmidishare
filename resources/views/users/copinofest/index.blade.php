        ...
        <section class="gradient-bg py-5">
            <div class="container-fluid row p-4 d-flex align-items-center justify-content-between">
                ...
                <div class="container text-center mt-3 col-12">
                    <h2>COP Inofest - Pilih Materi</h3>
                        <div></div>
                </div>
            </div>
        </section>
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4 justify-content-center">
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer">
                            <a class="btn btn-secondary" href="{{ route('copinofest.materi') }}"
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-footer">
                            <a class="btn btn-secondary" href="{{ route('copinofest.video') }}">Views details &raquo;</a>
                        </div>
                    </div>
                </div>
            </div>
