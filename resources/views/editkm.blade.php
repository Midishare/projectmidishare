...
<div class="container" style="margin-top: 7rem;">
    <div class="row justify-content-center">
        <div class="col-md-8 col-sm-12 bg-white p-4">
            ...
            <form method="post" action="{{ route('knowledge.editkm_process') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <label>File</label>
                    <input type="file" class="form-control" name="dokumenfile" placeholder="Dokumen">
                </div>   
