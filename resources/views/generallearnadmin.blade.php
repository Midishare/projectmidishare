                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
                    ...
                    <div class="col">
                        <div class="card h-100 p-3">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <a class="btn btn-secondary" href="{{ route('admin.ikt.index') }}">View details &raquo;</a>
                            </div>
                        </div>
                    </div>
                    <!-- DP Card -->
                    <div class="col">
                        <div class="card h-100 p-3">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <a class="btn btn-secondary" href="{{ route('admin.mvp.index') }}">View details &raquo;</a>
                            </div>
                        </div>
                    </div>
                    <!-- IP Card -->
                    <div class="col">
                        <div class="card h-100 p-3">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <a class="btn btn-secondary" href="{{ route('admin.ino.index') }}">View details &raquo;</a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 p-3">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <a class="btn btn-secondary" href="{{ route('admin.finlit.index') }}">View details &raquo;</a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 p-3">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <a class="btn btn-secondary" href="{{ route('admin.webinar.index') }}">View details &raquo;</a>
                            </div>
                        </div>
                    </div>
                </div>
