...
@section('content')
    <div class="container">
        <h2 style="margin-top: 100px;">Admin Cop Komunitas Prapensiun - Materi Dokumen</h2>
        ...
        <div class="col-md-6">
            <a href="{{ route('admin.copkompra.materi.create') }}">
        ...
        <form id="bulkDeleteForm" method="POST" action="{{ route('admin.copkompra.materi.bulkDelete') }}">
            @csrf
                ...
                <tbody>
                    @foreach ($documents as $index => $document)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.copkompra.materi.edit', $document->id) }}"
    ...
    <script>
        ...
        function searchBerita() {
            ...
            window.location.href = "{{ route('admin.copkompra.materi') }}?search=" + encodeURIComponent(keyword);
        }
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.copkompra.materi.destroy', '') }}/" + id;
                }
            });
        }
