...
@section('content')
    ...
    <div class="container">
        <h2 class="text-center">Video Cop Komunitas Prapensiun</h2>
        <div class="col-md-12 bg-white p-4">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('admin.videocopkompra.video.create') }}" class="btn btn-primary">Add Video</a>
                </div>
                <div class="col-md-6 text-right">
                    <div class="row g-2 align-items-center justify-content-end">
                        <form action="{{ route('admin.videocopkompra.video') }}" method="GET">
        ...
        <form id="bulkDeleteForm" method="POST" action="{{ route('admin.videocopkompra.video.bulkDelete') }}">
            @csrf
            @method('DELETE')
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($videocopkompra as $video)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.videocopkompra.video.edit', $video->id) }}"
        ...
        function confirmDelete(videoId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.action = `/admin/copkompra/video/${videoId}`;
                    form.method = 'POST';
