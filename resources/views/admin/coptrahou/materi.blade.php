...
@section('content')
    <div class="container">
        <h2 style="margin-top: 100px;">Admin coptrahou - Materi Dokumen</h2>
        ...
        <div class="col-md-6">
            <a href="{{ route('admin.coptrahou.materi.create') }}">
        ...
        <form id="bulkDeleteForm" method="POST" action="{{ route('admin.coptrahou.materi.bulkDelete') }}">
            @csrf
                ...
                <tbody>
                    @foreach ($documents as $index => $document)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.coptrahou.materi.edit', $document->id) }}"
    ...
    <script>
        function searchBerita() {
            ...
            window.location.href = "{{ route('admin.coptrahou.materi') }}?search=" + encodeURIComponent(keyword);
        }
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.coptrahou.materi.destroy', '') }}/" + id;
                }
            });
        }
