...
@section('content')
    <div class="container">
        ...
        <div class="col-md-6">
            <a href="{{ route('admin.copfresh.materi.create') }}">
        ...
        <form id="bulkDeleteForm" method="POST" action="{{ route('admin.copfresh.materi.bulkDelete') }}">
            @csrf
                ...
                <tbody>
                    @foreach ($documents as $index => $document)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.copfresh.materi.edit', $document->id) }}"
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.copfresh.materi.destroy', '') }}/" + id;
                }
            });
        }
