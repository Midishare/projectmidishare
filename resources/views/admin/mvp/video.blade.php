...
@section('content')
    ...
    <div style="margin-top: 7rem;" class="animated fadeIn">
        ...
        <div class="col-md-12 bg-white p-4">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('admin.mvp.video.create') }}">
            ...
            <form id="bulkDeleteForm" method="POST" action="{{ route('admin.mvp.video.bulkDelete') }}">
                @csrf
                    ...
                    <tbody>
                        @foreach ($videos as $i => $video)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.mvp.video.edit', $video->id) }}"
    ...
    <script>
        function searchVideo() {
            ...
            window.location.href = "{{ route('admin.mvp.video') }}?search=" + keyword;
        }
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.mvp.video.destroy', '') }}/" + id;
                }
            })
        }
