...
@section('content')
    ...
    <div class="container">
        <h2 class="text-center">Video Buku Pintar WH</h2>
        <div class="col-md-12 bg-white p-4">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('admin.videobukupintarwh.video.create') }}" class="btn btn-primary">Tambah Video</a>
                </div>
                <div class="col-md-6 text-right">
                    <div class="row g-2 align-items-center justify-content-end">
                        <form action="{{ route('admin.videobukupintarwh.video') }}" method="GET">
        ...
        <form id="bulkDeleteForm" method="POST" action="{{ route('admin.videobukupintarwh.video.bulkDelete') }}">
            @csrf
            @method('DELETE')
