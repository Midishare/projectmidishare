...
<div class="container">
    ...
    <form action="{{ route('admin.ino.materi.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="form-group mb-3">
            ...
            <select name="category" class="form-control" id="category" required>
                ...
                <option value="Head Office" {{ old('category') == 'Head Office' ? 'selected' : '' }}>Head Office</option>
