    ...
    <div class="container">
        ...
        <form action="{{ route('admin.ino.video.update', $video->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control" id="link" name="video_link"
                    value="{{ old('link', $video->video_link) }}" required>
                @error('video_link')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="category" class="form-control" id="category" required>
                    ...
                    <option value="Head Office" {{ $video->category == 'Head Office' ? 'selected' : '' }}>Head Office
                    </option>
