...
@section('content')
    ...
    <div style="margin-top: 7rem;" class="animated fadeIn">
        <h2 class="text-center">Financial Literasi - Video</h2>
        ...
        <div class="col-md-12 bg-white p-4">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('admin.finlit.video.create') }}">
            ...
            <form id="bulkDeleteForm" method="POST" action="{{ route('admin.finlit.video.bulkDelete') }}">
                @csrf
                    ...
                    <tbody>
                        @foreach ($videos as $i => $video)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.finlit.video.edit', $video->id) }}"
                                        class="btn btn-warning">Edit</a>
                                    <a href="javascript:void(0);" onclick="confirmDelete({{ $video->id }})"
    ...
    <script>
        function searchVideo() {
            ...
            window.location.href = "{{ route('admin.finlit.video') }}?search=" + keyword;
        }
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.finlit.video.destroy', '') }}/" + id;
                }
            })
        }
