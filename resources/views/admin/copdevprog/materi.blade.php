...
@section('content')
    <div class="container">
        <h2 style="margin-top: 100px;">Admin copdevprog - Materi Dokumen</h2>
        ...
        <div class="col-md-6">
            <a href="{{ route('admin.copdevprog.materi.create') }}">
        ...
        <form id="bulkDeleteForm" method="POST" action="{{ route('admin.copdevprog.materi.bulkDelete') }}">
            @csrf
                ...
                <tbody>
                    @foreach ($documents as $index => $document)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.copdevprog.materi.edit', $document->id) }}"
    ...
    <script>
        ...
        function searchBerita() {
            ...
            window.location.href = "{{ route('admin.copdevprog.materi') }}?search=" + encodeURIComponent(keyword);
        }
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.copdevprog.materi.destroy', '') }}/" + id;
                }
            });
        }
