        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <a class="btn btn-secondary" href="{{ route('admin.dp.materi') }}" class="btn btn-primary btn-lg">Vies Details</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-secondary" href="{{ route('admin.dp.video') }}">View details &raquo;</a>
                </div>
            </div>
        </div>
    </div>
