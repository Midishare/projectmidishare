...
@section('content')
    ...
    <div style="margin-top: 7rem;" class="animated fadeIn">
        ...
        <div class="col-md-12 bg-white p-4">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('admin.dp.video.create') }}">
            ...
            <form id="bulkDeleteForm" method="POST" action="{{ route('admin.dp.video.bulk_delete') }}">
                @csrf
                    ...
                    <tbody>
                        @foreach ($videos as $i => $video)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.dp.video.edit', $video->id) }}" class="btn btn-warning">
    ...
    <script>
        function searchVideo() {
            ...
            window.location.href = "{{ route('admin.dp.video') }}?search=" + keyword;
        }
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.dp.video.destroy', '') }}/" + id;
                }
            })
        }
