...
@section('content')
<div class="container">
    <h2 style="margin-top: 100px;">Admin DP - Materi Dokumen</h2>
    ...
    <div class="col-md-6">
        <a href="{{ route('admin.dp.materi.create') }}">
    ...
    <form id="bulkDeleteForm" method="POST" action="{{ route('admin.dp.materi.bulkDelete') }}">
        @csrf
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.dp.materi.edit', $document->id) }}" class="btn btn-primary">Edit</a>
...
<script>
    ...
    window.location.href = "{{ route('admin.dp.materi') }}?search=" + encodeURIComponent(keyword);
}
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "{{ route('admin.dp.materi.destroy', '') }}/" + id;
            }
        });
    }
