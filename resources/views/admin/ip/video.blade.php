...
<div style="margin-top: 7rem;" class="animated fadeIn">
    ...
    <div class="col-md-12 bg-white p-4">
        <div class="row">
            <div class="col-md-6">
                <a href="{{ route('admin.ip.video.create') }}">
        ...
        <form id="bulkDeleteForm" method="POST" action="{{ route('admin.ip.video.bulk_delete') }}">
            @csrf
...
<script>
    function searchVideo() {
        ...
        window.location.href = "{{ route('admin.ip.video') }}?search=" + keyword;
    }
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "{{ route('admin.ip.video.destroy', '') }}/" + id;
            }
        })
    }
