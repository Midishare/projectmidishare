...
@section('content')
<div class="container">
    <h2 style="margin-top: 100px;">Admin IKT - Materi Dokumen</h2>
    ...
    <div class="col-md-6">
        <a href="{{ route('admin.ikt.materi.create') }}">
    ...
    <form id="bulkDeleteForm" method="POST" action="{{ route('admin.ikt.materi.bulkDelete') }}">
        @csrf
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.ikt.materi.edit', $document->id) }}" class="btn btn-primary">Edit</a>
...
<script>
    ...
    window.location.href = "{{ route('admin.ikt.materi') }}?search=" + encodeURIComponent(keyword);
}
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "{{ route('admin.ikt.materi.destroy', '') }}/" + id;
            }
        });
    }
